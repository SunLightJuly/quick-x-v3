...
function WelcomeScene:createOpenRecents(recents)
    ...
    local evl = cc.EventListenerCustom:create("WELCOME_OPEN_PROJECT_ARGS", function(event) print("help me", event._userdata) end )
    self:getEventDispatcher():addEventListenerWithFixedPriority(evl, 1)
